    ...
    def paintEvent(self, event):
        ...
        for index in list(range(start_page_index, last_page_index)):
            if index < self.page_total_number:
                ...
                # Draw page image.
                visible_x = max(min(render_x + self.horizontal_offset, 0), self.rect().width() - render_width) # limit the visiable area size
                painter.drawPixmap(QRect(visible_x, render_y, render_width, render_height), qpixmap)
